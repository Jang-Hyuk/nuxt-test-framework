...
export interface VuetifyDialog {
	// Custom Method
	videoCall(params?: object, options?: object): Promise<T>;
	// Base Method
	component(name: string, options: object | VueConstructor): void;
	create<T = any>(component: object | VueConstructor): DialogObject<T>;
	show<T = any>(
		component: object | VueConstructor,
		params?: DialogOptionsWait,
	): Promise<T>;
	show<T = any>(
		component: object | VueConstructor,
		params?: DialogOptionsNoWait,
	): Promise<DialogObject<T>>;
	showAndWait<T = any>(
		component: object | VueConstructor,
